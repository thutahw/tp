...
public class CommandTestUtil {
    ...
    public static final String EMAIL_DESC_AMY = " " + PREFIX_GENDER + VALID_EMAIL_AMY;
    public static final String EMAIL_DESC_BOB = " " + PREFIX_GENDER + VALID_EMAIL_BOB;
    ...
    public static final String INVALID_EMAIL_DESC = " " + PREFIX_GENDER + "bob!yahoo"; // missing '@' symbol
