...
public class AppointmentCommandTestUtil {
     ...
     */
    public static void assertAppointmentCommandSuccess(Command command, Model actualModel,
    ...
    /**
     * Convenience wrapper to {@link #assertAppointmentCommandSuccess(Command, Model, CommandResult, Model)}
     * that takes a string {@code expectedMessage}.
     */
    public static void assertAppointmentCommandSuccess(Command command, Model actualModel, String expectedMessage,
                                                   Model expectedModel) {
        CommandResult expectedCommandResult = new CommandResult(expectedMessage, command.getTabNumber());
        assertAppointmentCommandSuccess(command, actualModel, expectedCommandResult, expectedModel);
    }
