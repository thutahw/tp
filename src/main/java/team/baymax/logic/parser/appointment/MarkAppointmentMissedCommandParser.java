...
public class MarkAppointmentMissedCommandParser implements Parser<MarkAppointmentMissedCommand> {
    /**
     * Parses the given {@code String} of arguments in the context of the MarkAppointmentMissedCommand
        ...
        if (arePrefixesPresent(argMultimap, PREFIX_DATETIME, PREFIX_NAME)) {
            ...
            try {
                ...
                throw new ParseException(
                        String.format(MESSAGE_INVALID_COMMAND_FORMAT, MarkAppointmentMissedCommand.MESSAGE_USAGE), pe);
            }
            return new MarkAppointmentMissedCommand(dateTime, name);
        } else {
            Index index;
            try {
            ...
            return new MarkAppointmentMissedCommand(index);
        }
    }
}
